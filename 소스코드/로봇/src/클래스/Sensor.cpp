...
String Sensor::Sensing_gps_hardness() {  //gps 경도값 센싱
    /*    gps 경도값 가져오기
       return : (String)경도값
...
String Sensor::Sensing_gps_latitude() { //gps 위도값 센싱
    /*    gps 위도값 가져오기
       return : (String)위도값
       // float 형의 값을 string 형으로 변환에서 리턴
    */
...
String Sensor::Sensing_gps_altitud() {
    /*    gps 고도값 가져오기
       return : (String)고도값
       // float 형의 값을 string 형으로 변환에서 리턴
    */
...
String Sensor::get_altitude_altitude() { //고도 센서에서 고도값 가져오기
    return _altitud;
}
String Sensor::get_altitude_temperature() { //고도 센서에서 온도값 가져오기
    return _temperature;
}
